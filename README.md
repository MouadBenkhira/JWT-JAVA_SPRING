...
This project is a simple Employee  System built with Spring Boot. It serves as a learning project to demonstrate knowledge of Java, Spring Boot, Security (JWT), and Docker.
